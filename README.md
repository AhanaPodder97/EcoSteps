...
Throughout this UI/UX capstone project, I mapped out the entire experience using the 5S Design Model:
...
Skeleton to create intuitive wireframes

Surface to bring the app to life with a fresh, nature-inspired visual identity

I spoke to different user types — the conscious beginner, the busy professional, the family-oriented homemaker — and translated their motivations and fears into meaningful design decisions.

🔄 What EcoSteps Helps Users Do

EcoSteps motivates users to adopt sustainable habits through:

Bite-sized daily actions

Streaks, rewards, and achievements

A friendly, non-judgmental tone

Clear visual impact insights

A community that grows with them

Every screen, every flow, and every visual choice supports one core promise:

Sustainable living should feel empowering, not exhausting.
